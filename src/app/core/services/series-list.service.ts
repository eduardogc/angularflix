  ...
  private series = [
    {
      ...
      description: `Acompanhamos os principais eventos do Brasil e do mundo,
                    com reportagens, entrevistas e imagens exclusivas para você saber tudo que acontece! `,
      color: '#0080ff'
    },
    {
      ...
      description: `Você já sabe que cuidar da alimentação é importante.
                    Mas se depara com tantas orientações sobre o que é certo e errado,
                    tantas dietas “milagrosas”, que acaba se sentindo meio perdido para dar um primeiro passo.
                    Aqui, você encontra dicas para dar todos os passos em prol da sua saúde!`,
      color: '#9654ec'
    },
    {
      ...
      description: `Tecnologias do passado, presente e futuro pelo olhar de pesquisadores que buscam respostas.
                    Aqui você encontra uma galera que vai muito além dos modismos high tech para propor uma
                    visão mais ampla da ciência ao longo da história da humanidade!`,
      color: '#3586A7'
    },
    {
      title: 'História',
      ...
      description: `Além da história tradicional que aprendemos nos livros escolares, muitos eventos da
                    humanidade ainda estão à margem. Nesse espaço, nossos pesquisadores compartilham novas
                    perspectivas para que você possa refletir!`,
      color: '#d5d5d5'
    },
    {
      title: 'Humor',
      ...
      description: `Leveza e descontração é o que você encontra aqui. Com sátiras do nosso cotidiano,
                    esse espaço é garantia de boas risadas com uma pitadinha de reflexão.
                    Porque a alegria é a maior frequência do universo!`,
      color: '#ffe700'
    },
    {
      title: 'Notícias',
      ...
      description: `Notícias que ultrapassam o tempo para nos colocar numa constante reflexão sobre
                    o mundo que nos cerca e os rumos da humanidade. Aqui mostramos o que foi divulgado nos
                    mais diversos canais para trazer a você reflexões e indagações sobre nosso mundo atual.`,
      color: '#ff0000'
    },
    {
      ...
      description: `Nossos pesquisadores têm aqui um espaço aberto para provocar reflexões.
                    Sem muito protocolo, este é o local para despertar novas ideias para que você possa
                    ver um mundo e a nossa história sob uma nova perspectiva.`,
      color: '#004377'
    },
    {
      ...
      description: `Sua saúde é uma das chaves para viver mais e melhor.
                    Por isso, dedicamos uma sessão toda especial para estimular reflexões de “como” ter
                    mais saúde! São dicas, entrevistas e treinos físicos para você se cuidar!`,
      color: '#80ff00'
    },
    {
      title: 'Viagens',
      ...
      description: `Está em busca de um destino instigante para seu próximo passeio?
                    Prepare seu passaporte, sua mente o seu coração para viajar e conhecer não apenas
                    as belezas, mas todo conhecimento que a viagens proporcionam!`,
      color: '#ffffff'
    },
    {
      title: 'Entrevistas',
      ...
      description: `Bate-papo repleto de conteúdo é o que você encontra aqui.
                    Os entrevistados debatem sobre os mais diferentes temas, sem rodeios ou polêmicas,
                    para que você possa conhecer uma nova visão sobre os fenômenos, sejam eles físicos,
                    psíquicos, históricos, religiosos ou sociais.`,
      color: '#DBB000'
    }
  ];
