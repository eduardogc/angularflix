...
export class VideoPlayerComponent implements OnInit {
  ...
  getTranslationForTemplate(videoUrlString) {
    ...
    if (width > 570) {
      return `<iframe width="560" height="315" src="${videoUrlString}" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
    } else {
      return `<iframe width="320" height="180" src="${videoUrlString}" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
    }
  }
